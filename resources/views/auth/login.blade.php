                ...
                <form id="loginForm" class="card" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="card-header">
                            ...
                            <div class="inputForm">
                                ...
                                <input placeholder="Insira sua senha" class="input" type="password" name="password" required>
                            </div>
                            <p class="p">Não tem uma conta? <a href="{{ route('usuarios.create') }}"><span class="span">Cadastre-se</span></a></p>
                    </div>
