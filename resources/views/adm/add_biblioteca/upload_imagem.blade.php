...
<body background="../../assets/img/ti2.jpg">
    ...
    <div class="cont">
        <form action="{{ route('uploadImg.image') }}" method="POST" enctype="multipart/form-data" id="file">
            @csrf
            <div class="area">
                ...
                <input type="file" accept="image/jpeg" name="image" id="fileInput" onchange="previewImage(event)" required>
            </div>
